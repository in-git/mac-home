    ...
    <div className="w-full h-full flex flex-col items-center select-none relative group min-h-0">
      ...
      <div className="flex-1 min-h-0 w-full flex items-center justify-center">
        ...
        >
          ...
          {/* Badge if present */}
          {item.badge && (
            <span className="absolute -top-1 -right-1 min-w-[16px] h-4 px-1 rounded-full  text-white text-md font-bold flex items-center justify-center border border-white shadow-xs">
              {item.badge}
            </span>
          )}
        </div>
