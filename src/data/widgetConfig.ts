...
import { getSizeOptions } from './options';
...
export const WIDGET_CONFIG: WidgetItem[] = [
  ...
  },
  {
    ...
    maxInstances: 1,
    size: '1/2',
    sizeOptions: getSizeOptions('wide-large'),
    isAddable: true,
    logo: '⛅',
    showHeader: false,
    data: {},
  },
  {
    ...
    maxInstances: 1,
    size: '1/2',
    sizeOptions: getSizeOptions('third-fifth-sixth'),
    isAddable: true,
    logo: '📝',
    showHeader: false,
    data: {},
  ...
  },
  {
    ...
    maxInstances: 1,
    size: '1/4',
    sizeOptions: getSizeOptions('sm-only'),
    isAddable: true,
    logo: '🎛️',
    showHeader: false,
    data: {},
  ...
  },
  {
    ...
    maxInstances: 999,
    size: '1/4',
    sizeOptions: getSizeOptions('all'),
    isAddable: true,
    logo: '⬜',
    showHeader: false,
    cardStyle: {
...
const FALLBACK_CONFIG: WidgetItem = {
  ...
  maxInstances: Infinity,
  size: '1/4',
  sizeOptions: getSizeOptions('wide-sm-large'),
  isAddable: false,
  logo: '🔗',
  showHeader: false,
  data: {},
