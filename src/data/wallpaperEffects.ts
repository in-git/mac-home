...
export const dynamicPresets: { id: DynamicPreset; name: string; desc: string; previewColor: string }[] = [
    ...
    },
    {
        ...
        name: '星空漂移 (Starfield)',
        desc: '缓慢漂移的星点与呼吸闪烁',
        previewColor: 'from-slate-900 via-indigo-900 to-black',
    },
    {
        id: 'cyber-grid',
        name: '赛博网格 (Cyber Grid)',
        desc: '透视网格与纵深光学地平线',
        previewColor: 'from-cyan-500 via-blue-600 to-purple-700',
    },
    {
        id: 'quantum-glow',
        name: '量子光晕 (Quantum Glow)',
        desc: '中心呼吸扩散的同心光晕',
        previewColor: 'from-sky-500 via-indigo-500 to-purple-600',
    },
    {
        id: 'dual-sine',
        name: '正弦双生波 (Dual Sine)',
        desc: '两道交错流动的正弦曲线',
        previewColor: 'from-emerald-400 via-teal-500 to-green-600',
    },
    {
        id: 'matrix-rain',
        name: '数字雨 (Matrix Rain)',
        desc: '经典字符瀑布流特效',
        previewColor: 'from-green-400 via-emerald-500 to-green-700',
    },
    {
        id: 'pulse-rings',
        name: '脉冲同心圆 (Pulse Rings)',
        desc: '由内向外扩散的脉冲圆环',
        previewColor: 'from-sky-400 via-cyan-500 to-blue-600',
    },
    {
        id: 'shooting-stars',
        name: '流星划过 (Shooting Stars)',
        desc: '间歇划过的流星拖尾',
        previewColor: 'from-slate-800 via-indigo-700 to-black',
    },
    {
        id: 'constellation',
        name: '星图连线 (Constellation)',
        desc: '浮动点位临近自动连线',
        previewColor: 'from-indigo-400 via-purple-500 to-pink-500',
    },
    {
        id: 'breathing-orbs',
        name: '呼吸光点 (Breathing Orbs)',
        desc: '缓慢呼吸的柔光球体',
        previewColor: 'from-purple-400 via-fuchsia-400 to-pink-400',
    },
    {
        id: 'floating-geometry',
        name: '浮动几何 (Floating Geometry)',
        desc: '旋转漂浮的几何方块',
        previewColor: 'from-slate-300 via-blue-300 to-indigo-400',
    },
];