...
export function Dropdown({ value, options, onChange, className = '' }: DropdownProps) {
  ...
  return (
    <button
      ...
      className={`flex items-center gap-1 rounded-[10px] px-1.5 py-1 text-[11px] font-medium text-slate-700 transition-colors hover:bg-black/5 dark:text-slate-200 dark:hover:bg-white/10 ${className}`}
    >
