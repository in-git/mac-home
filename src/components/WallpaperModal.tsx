  ...
  return (
    <div>
      ...
      <div className="mt-2.5 flex min-h-[18px] items-center gap-2 px-1">
        {isApplied ? (
          <span className="shrink-0 rounded-full bg-[color:var(--accent)] px-2 py-0.5 text-[10px] font-semibold text-white">
            当前
          </span>
        ) : (
          <span className="shrink-0 rounded-full bg-black/10 px-2 py-0.5 text-[10px] font-medium text-slate-500 dark:bg-white/10 dark:text-slate-300">
            预览
          </span>
        )}
