    ...
    <div className="shrink-0 border-t border-black/[0.06] dark:border-white/[0.08]">
      ...
      {items.length > 0 && (
        <div className="px-2 pb-1 pt-2">
          <p className="px-2 pb-1 text-[10px] font-medium uppercase tracking-wider text-[#86868B] dark:text-[#98989D]">
            站点数据
          </p>
      ...
      {/* 备案信息：苹果次级文本风格 */}
      <div className="space-y-1 border-t border-black/[0.06] px-4 py-3 dark:border-white/[0.08]">
        <a
          href="https://beian.mps.gov.cn/#/query/webSearch?code=44011202003613"
          target="_blank"
          rel="noopener noreferrer"
          title="粤公网安备44011202003613号"
          className="group flex items-center gap-1.5 text-[11px] leading-relaxed text-[#86868B] transition-colors hover:text-[color:var(--accent)] dark:text-[#98989D]"
        >
        ...
        <p className="text-[11px] leading-relaxed text-[#A1A1A6] dark:text-[#6E6E73]">
