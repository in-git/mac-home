    ...
    >
      <div className="space-y-3">
        ...
        <button
          ...
          className="mt-2 flex w-full items-center justify-center gap-2 rounded-[var(--card-radius)] bg-[#007AFF] py-3 text-[15px] font-medium text-white shadow-sm transition-all duration-150 hover:bg-[#0070e0] active:scale-[0.985] disabled:opacity-60"
        >
