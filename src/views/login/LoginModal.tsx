    ...
    >
      <div className="space-y-3">
        ...
        <button
          ...
          className="mt-2 flex w-full items-center justify-center gap-2 rounded-md bg-blue-500 py-3 text-font-md  text-white shadow-sm duration-150 hover:bg-[color:var(--accent-hover)] active:scale-[0.985] disabled:opacity-60"
        >
